			...
			<div class="main">
				...
				<div class="cmsMain">
					<form class="mTB10 mL10 mR10" name="form2"
						action="index.php?m=company&c=product&f=product_edit_save"
						method="post">
							...
							<tbody>
								<tr>
									...
									<td><input name="title" type="text" id="title" size="20"
										class="text" value="小炒肉" /> <span style="color:red;">*</span></td>
								</tr>
								<tr>
									<td align="right" valign="top"><span class="tdl">分类：</span></td>
									<td><select name="catid" id="select">

											<option value="5" selected="selected">快餐</option>
